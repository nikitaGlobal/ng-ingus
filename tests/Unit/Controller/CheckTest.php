...
Пишите "+" в лс',
			'Приветствую
Нужны люди на интересные темы
Мы предоставляем : 

Отличный заработо
Удобный для вас график
Высокую поддержку 24 на 7
...
Интересно? Пиши в ЛС',
			...
			'Eсли интерeснo, пиши “Готов” в личныe сooбщeния!',
			'Ты до сих пор сидишь без денег? Люди с нуля уже забирают по 20 000+ в месяц 💸 Всё легально, просто и с телефона 📱 Успей в команду, пока набор открыт! пиши в ЛС "ХОЧУ"',
			'Ребята, есть тема подработать! Без вложений, подходит всем. В день от 2-3 тысяч. Пиши в личку, расскажу.',
		);
